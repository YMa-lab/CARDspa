...
#' CARD_obj = CARD_imputation(CARD_obj,NumGrids = 200,ineibor = 10,exclude = NULL)
#' print(CARD_obj@refined_prop[1:3,1:3])
#'
CARD_imputation <- function(CARD_object,NumGrids,ineibor = 10,exclude = NULL){
